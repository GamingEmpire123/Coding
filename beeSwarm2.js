    ...
    rightGuard:{
        ...
        cobaltGuard:{
            ...
            applyStats:function(stats,player){
                ...
                stats.convertRate*=40
                stats.capacity+=300000000
                stats.bluePollen*=3000
                stats.instantBlueConversion=window.applyPercentage(stats.instantBlueConversion,0.2)
                stats.blueBombPollen*=1.5
                stats.blueBeeAttack+=3000
                stats.whiteBeeAttack+=2000
                stats.criticalPower+=1
                player.addEffect('hastePulserPassive')
            },
            desc:'A guard bestowed with the heroic power of Cobalt Bee - Defender of the blue bees.<br><br>+300,000,000 capacity<br>x1.35 blue pollen<br>x40 convert rate<br>+2000% instant blue conversion<br>x1.5 blue bomb pollen<br>+3000 blue bee attack<br>+2000 white bee attack<br>+1000% critical power<br>+Passive: Haste Pulser',
            cost:['200000000 honey','0 blueExtract','0 stinger','0 enzymes','0 glitter'],
        },
    }
}
})()
